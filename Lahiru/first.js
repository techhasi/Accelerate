...
function printgrandtotal(){
    ...
    invoice()
    ready()
    document.getElementsByClassName("pricea")[0].innerText = 'Total Amount $' + total
}
...
function invoice(){
    ...
    if(name == null || name =="",email == null || email ==""){
        ...
        document.getElementById("U-Name").innerHTML = "Name:  "+ name;
        document.getElementById("gg").innerHTML= "Accelarate";
